 ...
 // printf("L%d %f %f \n",l,d[3],e[3]);
    for ( j = 0; j <= l; j++ )
    {
      ...
      for ( k = j; k <= l; k++ )
      {
        ...
        //if(j==3 && k==5)printf("L %f %f  %f %f %f %f\n",z[k+j*n],f,e[k],g,d[k],z[k+j*n] - f * e[k] - g * d[k]);
        //ACCES POSE SOUCIS COMME SI MEM PAS ALLOUER 
        //z[k+j*n]=0;
        //if(j==3 && k==5 && lol==NULL)lol=(int*)malloc(sizeof(int)*1);
